...
import { Stack, OutlinedInput, Typography, Button, MenuItem, List, ListItem} from "@mui/material"
...
function EquipmentPage(){
    ...
    const obtainedEquipment = useQuery({
        queryKey: ['equipments'],
        ...
        <div>
            ...
            <Stack direction="row" spacing={5}>
              <Stack spacing={1.5} width="50%" mb={4}>
               ...
               <List dense>
                  {obtainedEquipment.data?.map((equipment) => (
              ...
              <Stack spacing={1.5} width="50%" mb={5}>
                {equipmentLayout.map(({ label, type, field }) => (
                  <Stack key={label} direction="row" alignItems="center" spacing={2}>
                    ...
                    <OutlinedInput 
                      onChange={(e) => setEquipment({...equipment, [field]: e.target.value})}
                ...
                <Stack direction="row" pt={5} gap={5} >
                  <Button 
                    ...
                    onClick={() => addEquipment.mutate({
                        ...
                        purchaseYear:  equipment.purchaseYear   ? Number(equipment.purchaseYear) : undefined,
